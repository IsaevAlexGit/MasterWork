namespace Optimum
{
    partial class StartForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelAboutProgram.Location = new System.Drawing.Point(26, 176);
            this.labelAboutProgram.Name = "labelAboutProgram";
            this.labelAboutProgram.Size = new System.Drawing.Size(734, 42);
            this.labelAboutProgram.TabIndex = 6;
            this.labelAboutProgram.Text = "Геоинформационная система \"Оптимум\" поможет Вам выгодно разместить на карте город" +
    "а бизнес \r\nили найти наилучшее место для открытия нового объекта социальной инфр" +
    "аструктуры.";
            this.labelAboutProgram.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // buttonProceed
            // 
            this.buttonProceed.BackColor = System.Drawing.Color.PaleGreen;
            ...
            this.toolTip.SetToolTip(this.buttonProceed, "Выберите локализацию карты и переходите к начальным настройкам.");
            ...
            // buttonSelectColor
            // 
            this.buttonSelectColor.BackColor = System.Drawing.Color.LightGreen;
            ...
            this.toolTip.SetToolTip(this.buttonSelectColor, "Выберите основной цвет приложения, если Вам не нравится цвет по умолчанию.");
            ...
            // buttonManual
            // 
            this.buttonManual.BackColor = System.Drawing.Color.LightGreen;
            ...
            this.labelSelectLocal.TabIndex = 7;
            ...
            this.labelStateConnetion.TabIndex = 4;
