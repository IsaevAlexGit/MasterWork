...
namespace Optimum
{
    //! Класс для окна "Объект социальной инфраструктуры"
    public partial class FacilityInfo : Form
    {
        ...
        */
        ...
        /*!
        \version 1.0
        \warning Если на указанный сайт перейти невозможно, то пользователь увидит ошибку
        */
        /// <summary>
        /// Загрузка формы
        /// </summary>
        ...
        */
        ...
        /// <permission cref="">Доступ к функции: private</permission>
        /// <remarks>
        /// Функция обрабатываем закрытие окна
        /// </remarks>
